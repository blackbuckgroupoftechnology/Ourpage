...
const ClaimOverview = () => {
    return (
        <div className='border w-[560px] h-[435px] border-[#FFFFFFE8] bg-[#ECF0F9] rounded-2xl'>
            ...
            {[1, 2, 3].map((item, index) => {
                return (
                    <div key={index} className='border border-gray-400 rounded-xl h-[97px] p-3 flex justify-between items-center'>
                        ...
                        <div className='border h-[100px] flex flex-col justify-center items-center'>
