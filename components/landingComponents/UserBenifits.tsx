...
const UserBenifits = () => {
    return (
        <div>
            ...
            <div className='border p-4 rounded-2xl flex justify-evenly border-white shadow-xl'>
                {
                    BenifitData.map((item, index) => {
                        const Icon = item.img;
                        return (
                            <div key={index} className='p-4 rounded-lg flex flex-col justify-center border border-white shadow-xl'>
